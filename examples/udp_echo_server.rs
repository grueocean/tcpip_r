...
#[command(after_help = "EXAMPLES: ./udp_echo_server -i d0 -n 172.20.10.100/24 -g 172.20.10.1 -p 300")]
struct Args {
    ...
    #[arg(long, short = 'p', help = "Port for this udp server (0 if assign ephemeral port), e.g., 300", default_value_t  = 0)]
    port: u16,
}
