...
struct Args {
    ...
    #[arg(long, help = "Interface mac address, e.g., 11:22:33:44:55:66", default_value_t = MacAddress::new([0, 0, 0, 0, 0, 0]))]
    mac: MacAddress,

    #[arg(long, help = "Mtu for interface name, e.g., 1500", default_value_t  = 1500)]
    mtu: usize,
    ...
    #[arg(long, short = 'p', help = "Mtu for interface name, e.g., 1500", default_value_t  = 0)]
    port: u16,
}
